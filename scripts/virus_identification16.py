...
def parse_arguments():
    ...
    method_group.add_argument("--virbot_path", default=os.path.expanduser("~/biosoft/virus/VirBot/VirBot.py"))
    method_group.add_argument("--viralm_path", default=os.path.expanduser("~/bin/viralm_cpu.py"))
    ...
    method_group.add_argument("--virhunter_path",
                       default=os.path.expanduser("~/biosoft/virus/virhunter/virhunter/predict_cpu.py"),
                       help="VirHunter predict_cpu.py 路径")
    method_group.add_argument("--virhunter_weights",
                       default=os.path.expanduser("~/biosoft/virus/virhunter/weights/generalistic"),
